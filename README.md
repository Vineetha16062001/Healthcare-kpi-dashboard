...
Install Oracle XE (free) or PostgreSQL
Run sql/01_schema.sql to create tables
Run sql/02_seed_data.sql to load sample data
Run sql/03_kpi_views.sql to create the KPI views
Connect Power BI to your database (see powerbi/dashboard_setup.md)
Import the DAX measures from powerbi/dax_measures.md
Option B — CSV Only (No Database Needed)
Open Power BI Desktop
Import data/sample_export.csv
Follow powerbi/dashboard_setup.md from Step 3 onwards
Dashboard Preview
